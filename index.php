            ...
            <div class="w3-third">
                ...
                <div class="w3-white w3-text-grey w3-card-4">
                    ...
                    <div class="w3-container">
                        <p><i
                                class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $profession?>
                        </p>
                        <p><i
                                class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo "$city, $country"?>
                        </p>
                        <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $mail?>
                        </p>
            ...
            <div class="w3-twothird">
                ...
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    <h2 class="w3-text-grey w3-padding-16"><i
                            ...
                            <?php
                    for ($i = 0; $i < count($myExperience); $i++):
                        $expName = $myExperience[$i]['name'];
                        $expDateBegin = $myExperience[$i]['dateBegin'];
                        $expDateEnd = $myExperience[$i]['dateEnd'];
                        $expDescript = $myExperience[$i]['description'];
                    ?>
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b><?php echo $expName; ?></b></h5>
                        <h6 class="w3-text-teal">
                            <i class="fa fa-calendar fa-fw w3-margin-right"></i>
                            <?php echo $expDateBegin. ' - '; 
                            if ($expDateEnd == "Current") { ?> 
                                <span class="w3-tag w3-teal w3-round"><?php echo $expDateEnd; ?></span>
                            <?php } 
                            else {
                                echo $expDateEnd;
                            }?>
                        </h6>
                        <p><?php echo $expDescript; ?></p>
                        <?php if ($i != count($myExperience) - 1){ ?> <hr> <?php } ?>
                    </div>
                    <?php endfor?>
                </div>
